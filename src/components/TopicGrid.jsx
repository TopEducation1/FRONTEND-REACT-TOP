...
function TopicCard({
  ...
  /*
   * El slider no existe todavía cuando
   * el overlay está cerrado.
   *
   * Por eso recalculamos al abrir.
   */
  useEffect(() => {
    if (!showOverlay) {
      return;
  ...
  // OVERLAY
  //
  // tween rápido en lugar del spring original.
  // ============================================================
  ...
  return (
    <motion.article
       ...
       * NO layout.
       *
       * Era una de las animaciones que
       * interfería con parallax + hover.
       */
