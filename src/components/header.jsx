        ...
        <header>
            ...
            <nav className="nav-main">
                ...
                <div className="container-burguer-button">
                    <svg onClick={() => {
                            console.log('Botón del menú presionado'); // Debug
                            openIndexResponsiveMenu();
                        }}  xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-menu-2"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M4 6l16 0" /><path d="M4 12l16 0" /><path d="M4 18l16 0" /> </svg>
                </div>
