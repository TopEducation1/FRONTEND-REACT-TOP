...
const HeroSlider = ({authors}) => {
  ...
  return (
    <div className="hero-container flex flex-wrap w-full mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] xl:!mt-0 items-center">
      <div className="hero-text flex w-12/12 md:!ml-[8.33333333%] lg:!ml-0 lg:w-5/12 xl:!ml-0 xl:w-5/12 w-full flex-[0_0_auto] !px-[15px] xl:!px-[35px] lg:!px-[20px] !mt-[50px] xl:!mt-0 max-w-full text-center lg:text-left xl:text-left">
