   ...
   const topics = [
    {
      ...
      type: 'Tema',
      position: [{pos: 'topicText', size:'62', y:'7',x:'44'},{pos: 'topicImg', size: '32', y:'83',x:'51'},{pos: 'topicBlur', size: '38', y:'33',x:'20'}],
    ...
    },
    {
      ...
      type: 'Tema',
      position: [{pos: 'topicText', size:'58', y:'4',x:'28'},{pos: 'topicImg', size: '34', y:'76',x:'65'},{pos: 'topicBlur', size: '29', y:'20',x:'20'}],
      ...
      type: 'Tema',
      position: [{pos: 'topicText', size:'58', y:'30',x:'30'},{pos: 'topicImg', size: '25', y:'29',x:'3'},{pos: 'topicBlur', size: '39', y:'32',x:'72'}],
      ...
      type: 'Tema',
      position: [{pos: 'topicText', size:'36', y:'1',x:'36'},{pos: 'topicImg', size: '30', y:'18',x:'9'},{pos: 'topicBlur', size: '30', y:'35',x:'47'}],
      ...
      type: 'Tema',
      position: [{pos: 'topicText', size:'56', y:'92',x:'28'},{pos: 'topicImg', size: '40', y:'70',x:'85'},{pos: 'topicBlur', size: '50', y:'83',x:'62'}],
      ...
      type: 'Tema',
      position: [{pos: 'topicText', size:'53', y:'90',x:'48'},{pos: 'topicImg', size: '42', y:'60',x:'40'},{pos: 'topicBlur', size: '40', y:'39',x:'10'}],
      ...
      type: 'Tema',
      position: [{pos: 'topicText', size:'46', y:'78',x:'10'},{pos: 'topicImg', size: '33', y:'24',x:'48'},{pos: 'topicBlur', size: '33', y:'13',x:'45'}],
      ...
      name: 'Negocios',
      type: 'Tema',
      position: [{pos: 'topicText', size:'48', y:'13',x:'72'},{pos: 'topicImg', size: '34', y:'35',x:'33'},{pos: 'topicBlur', size: '34', y:'65',x:'32'}],
      ...
      name: 'Salud',
      type: 'Tema',
      position: [{pos: 'topicText', size:'85', y:'22',x:'30'},{pos: 'topicImg', size: '30', y:'71',x:'16'},{pos: 'topicBlur', size: '50', y:'71',x:'75'}],
      ...
      type: 'Tema',
      position: [{pos: 'topicText', size:'48', y:'77',x:'37'},{pos: 'topicImg', size: '32', y:'13',x:'36'},{pos: 'topicBlur', size: '24', y:'89',x:'22'}],
      ...
      name: 'Bienestar',
      type: 'Habilidad',
      position: [{pos: 'topicText', size:'58', y:'19',x:'43'},{pos: 'topicImg', size: '25', y:'85',x:'77'},{pos: 'topicBlur', size: '40', y:'74',x:'43'}],
      ...
      name: 'Comunicación',
      type: 'Habilidad',
      position: [{pos: 'topicText', size:'48', y:'22',x:'56'},{pos: 'topicImg', size: '36', y:'60',x:'3'},{pos: 'topicBlur', size: '45', y:'86',x:'39'}],
      ...
      name: 'Creatividad',
      type: 'Habilidad',
      position: [{pos: 'topicText', size:'80', y:'70',x:'24'},{pos: 'topicImg', size: '28', y:'64',x:'68'},{pos: 'topicBlur', size: '48', y:'60',x:'80'}],
      ...
      type: 'Habilidad',
      position: [{pos: 'topicText', size:'50', y:'13',x:'14'},{pos: 'topicImg', size: '25', y:'64',x:'56'},{pos: 'topicBlur', size: '25', y:'94',x:'59'}],
      ...
      type: 'Habilidad',
      position: [{pos: 'topicText', size:'58', y:'36',x:'1'},{pos: 'topicImg', size: '24', y:'24',x:'83'},{pos: 'topicBlur', size: '38', y:'27',x:'28'}],
      ...
      name: 'Estrategia',
      type: 'Habilidad',
      position: [{pos: 'topicText', size:'80', y:'86',x:'60'},{pos: 'topicImg', size: '30', y:'7',x:'22'},{pos: 'topicBlur', size: '36', y:'8',x:'32'}],
      ...
      name: 'Liderazgo',
      type: 'Habilidad',
      position: [{pos: 'topicText', size:'72', y:'80',x:'77'},{pos: 'topicImg', size: '25', y:'32',x:'63'},{pos: 'topicBlur', size: '25', y:'75',x:'27'}],
      ...
      type: 'Habilidad',
      position: [{pos: 'topicText', size:'65', y:'59',x:'55'},{pos: 'topicImg', size: '25', y:'63',x:'21'},{pos: 'topicBlur', size: '43', y:'39',x:'78'}],
      ...
      name: 'Productividad',
      type: 'Habilidad',
      position: [{pos: 'topicText', size:'78', y:'37',x:'45'},{pos: 'topicImg', size: '30', y:'79',x:'30'},{pos: 'topicBlur', size: '40', y:'73',x:'7'}],
      ...
      type: 'Habilidad',
      position: [{pos: 'topicText', size:'62', y:'85',x:'17'},{pos: 'topicImg', size: '32', y:'59',x:'89'},{pos: 'topicBlur', size: '32', y:'82',x:'18'}],
  ...
  return (
    <>
      ...
      <motion.section
        ...
        className="wrapper bg-[#0F090B] relative section z-10  sect-2"
      >
      ...
      <section
        ...
        style={{ height: `${3 * 100}vh` }} // 3 secciones × 100vh = 300vh de scroll vertical
      >
        <motion.div 
        ...
        style={{ background }}>
          ...
          >
            ...
            <section className="w-screen h-full flex-shrink-0 flex items-center justify-center px-10">
              <div className="container m-auto py-30 px-5 max-w-[90vw] text-center">
                <h2 className="text-white text-4xl lg:text-6xl font-normal italic leading-[1.2em] mb-5">
            ...
            {/* Sección 4 */}
            <section className="w-screen h-full flex-shrink-0 flex items-center justify-center  px-10">
              <div className="container m-auto max-w-[90vw] text-center">
                <div className="rounded-lg border border-[#0F090B] px-5 py-10 lg:px-10">
                  <h2 className="text-[#0F090B] text-5xl font-normal leading-[1.2em] mb-5">
                    Forma equipos que <span className="italic">aprenden y crecen</span>
                  </h2>
                  <p className="text-[#0F090B] text-2xl mb-5">
                    Potencia las habilidades de tu equipo con certificaciones clave y seguimiento en tiempo real...
                  </p>
                  <div className="w-full lg:w-1/2 mx-auto gap-4 mb-10 text-center">
                    <PlatformsSelector platforms={platforms} />
                  </div>
                  <Link to="/para-equipos" className="btn btn-col-3 py-3 px-5 text-[18px] lg:text-2xl">
            ...
            {/* Sección 5 */}
            <section className="w-screen h-full flex-shrink-0 flex items-center justify-center px-10">
              <div className="m-auto max-w-[100vw] text-center">
      ...
      {/* Sección 6 */}
      <section className="wrapper relative section sect-6">
