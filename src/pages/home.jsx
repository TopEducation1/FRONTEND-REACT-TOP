...
function HomePage() {
  const rawTopics = [
    {
      ...
      type: "Tema",
      position: [
        { pos: "topicText", size: "40", y: "9", x: "44" },
        { pos: "topicImg", size: "60", y: "84", x: "48" },
        { pos: "topicBlur", size: "30", y: "33", x: "15" },
      ],
      img: "assets/category/topic/ico-Aprendizaje-de-un-idioma",
      color: "#5CC781",
      description:
        "Expande tu universo cultural y profesional. Conecta a través del inglés, francés, alemán y más, cultivando habilidades de comunicación global.",
      universities: [
        {
          name: "UNAM",
          type: "Universidad",
    ...
    },
    {
      ...
      type: "Tema",
      position: [
        { pos: "topicText", size: "48", y: "4", x: "30" },
        { pos: "topicImg", size: "100", y: "76", x: "67" },
        { pos: "topicBlur", size: "22", y: "22", x: "17" },
      ],
      description:
        "Explora las ideas, historias y expresiones que definen quiénes somos. Conoce el legado cultural que moldea nuestra visión del mundo.",
      universities: [
        {
    ...
    },
    {
      ...
      type: "Tema",
      position: [
        { pos: "topicText", size: "48", y: "30", x: "30" },
        { pos: "topicImg", size: "34", y: "31", x: "3" },
        { pos: "topicBlur", size: "39", y: "30", x: "69" },
      ],
      img: "assets/category/topic/ico-Ciencia-de-datos",
      color: "#5CC781",
      description:
        "Convierte datos en decisiones inteligentes. Aprende a analizar, visualizar y comprender grandes volúmenes de información con impacto real.",
      universities: [
        {
          name: "IBM",
          type: "Empresa",
    ...
    },
    {
      ...
      type: "Tema",
      position: [
        { pos: "topicText", size: "26", y: "1", x: "36" },
        { pos: "topicImg", size: "30", y: "18", x: "9" },
        { pos: "topicBlur", size: "30", y: "35", x: "47" },
      ],
      img: "assets/category/topic/ico-Ciencias-de-la-computacion",
      color: "#034694",
      description:
        "Domina los lenguajes que impulsan la tecnología. Desde algoritmos hasta desarrollo de software, convierte ideas en soluciones digitales.",
      universities: [
        {
          name: "Massachusetts Institute of Technology",
          type: "Universidad",
    ...
    },
    {
      ...
      type: "Tema",
      position: [
        { pos: "topicText", size: "44", y: "92", x: "28" },
        { pos: "topicImg", size: "170", y: "72", x: "87" },
        { pos: "topicBlur", size: "30", y: "96", x: "37" },
      ],
      img: "assets/category/topic/ico-Ciencias-sociales",
      color: "#5CC781",
      description:
        "Comprende cómo pensamos, actuamos y evolucionamos como sociedad. Estudia economía, política y cultura para interpretar el mundo con criterio.",
      universities: [
        {
    ...
    },
    {
      ...
      type: "Tema",
      position: [
        { pos: "topicText", size: "43", y: "90", x: "48" },
        { pos: "topicImg", size: "59", y: "58", x: "36" },
        { pos: "topicBlur", size: "30", y: "55", x: "15" },
      ],
      img: "assets/category/topic/ico-Ciencias-fisicas-e-ingenieria",
      color: "#D33B3E",
      description:
        "Aprende a diseñar, modelar y resolver problemas reales. Desde los fundamentos físicos hasta la ingeniería de vanguardia.",
      universities: [
        {
    ...
    },
    {
      ...
      type: "Tema",
      position: [
        { pos: "topicText", size: "46", y: "34", x: "69" },
        { pos: "topicImg", size: "60", y: "18", x: "64" },
        { pos: "topicBlur", size: "35", y: "12", x: "52" },
      ],
      img: "assets/category/topic/ico-Desarrollo-personal",
      color: "#D33B3E",
      description:
        "Construye una versión más fuerte y consciente de ti. Aprende a tomar decisiones, comunicarte mejor y crecer en cada etapa de tu vida.",
      universities: [
        {
    ...
    },
    {
      ...
      type: "Tema",
      position: [
        { pos: "topicText", size: "36", y: "78", x: "10" },
        { pos: "topicImg", size: "45", y: "25", x: "48" },
        { pos: "topicBlur", size: "25", y: "16", x: "43" },
      ],
      img: "assets/category/topic/ico-Matematicas-y-logica",
      color: "#034694",
      description:
        "Activa tu pensamiento crítico. Aprende a resolver problemas complejos con lógica, estructura y claridad matemática.",
      universities: [
        {
    ...
    },
    {
      ...
      type: "Tema",
      position: [
        { pos: "topicText", size: "38", y: "13", x: "72" },
        { pos: "topicImg", size: "50", y: "36", x: "35" },
        { pos: "topicBlur", size: "34", y: "66", x: "34" },
      ],
      img: "assets/category/topic/ico-Negocios",
      color: "#D33B3E",
      description:
        "Comprende cómo se construyen, escalan y lideran organizaciones en la era digital. Desde marketing hasta modelos de negocio.",
      universities: [
        {
    ...
    },
    {
      ...
      type: "Tema",
      position: [
        { pos: "topicText", size: "74", y: "24", x: "32" },
        { pos: "topicImg", size: "32", y: "72", x: "7" },
        { pos: "topicBlur", size: "45", y: "61", x: "71" },
      ],
      img: "assets/category/topic/ico-Salud",
      color: "#D33B3E",
      description:
        "Conoce tu cuerpo, promueve hábitos sanos y comprende cómo prevenir enfermedades desde la ciencia y la práctica.",
      universities: [
        {
          name: "Harvard University",
          type: "Universidad",
    ...
    },
    {
      ...
      type: "Tema",
      position: [
        { pos: "topicText", size: "48", y: "55", x: "48" },
        { pos: "topicImg", size: "47", y: "18", x: "32" },
        { pos: "topicBlur", size: "24", y: "90", x: "22" },
      ],
      img: "assets/category/topic/ico-Tecnologia-de-la-informacion",
      color: "#5CC781",
      description:
        "Gestiona el backend del mundo digital. Aprende redes, sistemas y servicios en la nube que mueven al planeta.",
      universities: [
        {
    ...
    },
    {
      ...
      type: "Habilidad",
      position: [
        { pos: "topicText", size: "48", y: "19", x: "43" },
        { pos: "topicImg", size: "120", y: "68", x: "75" },
        { pos: "topicBlur", size: "40", y: "74", x: "48" },
      ],
      img: "assets/category/ability/ico-Bienestar",
      color: "#D33B3E",
      description:
        "Equilibra cuerpo, mente y entorno. Aprende a manejar el estrés, mejorar tu alimentación y cultivar salud mental.",
      universities: [
        {
    ...
    },
    {
      ...
      type: "Habilidad",
      position: [
        { pos: "topicText", size: "42", y: "75", x: "76" },
        { pos: "topicImg", size: "38", y: "57", x: "1" },
        { pos: "topicBlur", size: "35", y: "60", x: "48" },
      ],
      img: "assets/category/ability/ico-Comunicacion",
      color: "#034694",
      description:
        "Domina el arte de transmitir ideas con claridad y propósito. Aprende a persuadir, inspirar y conectar a través del lenguaje.",
      universities: [
        {
    ...
    },
    {
      ...
      type: "Habilidad",
      position: [
        { pos: "topicText", size: "70", y: "70", x: "20" },
        { pos: "topicImg", size: "62", y: "96", x: "53" },
        { pos: "topicBlur", size: "40", y: "65", x: "85" },
      ],
      img: "assets/category/ability/ico-Creatividad",
      color: "#D33B3E",
      description:
        "Despierta tu imaginación y transforma la forma en que ves el mundo. Aprende a innovar con pensamiento original y sensibilidad artística.",
      universities: [
        {
    ...
    },
    {
      ...
      type: "Habilidad",
      position: [
        { pos: "topicText", size: "40", y: "13", x: "14" },
        { pos: "topicImg", size: "70", y: "63", x: "63" },
        { pos: "topicBlur", size: "25", y: "94", x: "61" },
      ],
      img: "assets/category/ability/ico-Crecimiento-personal",
      color: "#5CC781",
      description:
        "Impulsa tu desarrollo emocional, físico y mental con el ejemplo de quienes superaron límites.",
      universities: [
        {
    ...
    },
    {
      ...
      type: "Habilidad",
      position: [
        { pos: "topicText", size: "48", y: "37", x: "1" },
        { pos: "topicImg", size: "60", y: "4", x: "60" },
        { pos: "topicBlur", size: "22", y: "23", x: "56" },
      ],
      img: "assets/category/ability/ico-Diversidad-equidad-e-inclusion",
      color: "#034694",
      description:
        "Comprende la riqueza de lo diverso y aprende a construir espacios más equitativos, empáticos y humanos.",
      universities: [
        {
    ...
    },
    {
      ...
      type: "Habilidad",
      position: [
        { pos: "topicText", size: "70", y: "83", x: "59" },
        { pos: "topicImg", size: "30", y: "7", x: "22" },
        { pos: "topicBlur", size: "36", y: "8", x: "32" },
      ],
      img: "assets/category/ability/ico-Estrategia",
      color: "#D33B3E",
      description:
        "Piensa en grande y actúa con visión. Aprende a planear, analizar y tomar decisiones que generan impacto.",
      universities: [
        {
    ...
    },
    {
      ...
      type: "Habilidad",
      position: [
        { pos: "topicText", size: "48", y: "79", x: "77" },
        { pos: "topicImg", size: "65", y: "31", x: "60" },
        { pos: "topicBlur", size: "25", y: "75", x: "27" },
      ],
      img: "assets/category/ability/ico-Liderazgo",
      color: "#5CC781",
      description:
        "Desarrolla tu capacidad de guiar, inspirar y transformar equipos. Aprende de grandes líderes y sus decisiones clave.",
      universities: [
        {
    ...
    },
    {
      ...
      type: "Habilidad",
      position: [
        { pos: "topicText", size: "48", y: "77", x: "37" },
        { pos: "topicImg", size: "42", y: "65", x: "22" },
        { pos: "topicBlur", size: "43", y: "38", x: "78" },
      ],
      img: "assets/category/ability/ico-Personas-y-cultura",
      color: "#5CC781",
      description:
        "Descubre cómo se crean las narrativas que nos unen. Desde sociología hasta cultura pop, entiende lo que mueve a las personas.",
      universities: [
        {
          name: "UNAM",
          type: "Universidad",
    ...
    },
    {
      ...
      type: "Tema",
      position: [
        { pos: "topicText", size: "68", y: "37", x: "45" },
        { pos: "topicImg", size: "280", y: "28", x: "88" },
        { pos: "topicBlur", size: "40", y: "16", x: "73" },
      ],
      img: "assets/category/ability/ico-Productividad",
      color: "#034694",
      description:
        "Gestiona tu tiempo, energía y enfoque con inteligencia. Aprende técnicas para hacer más con propósito y menos desgaste.",
      universities: [
        {
          name: "IBM",
          type: "Empresa",
    ...
    },
    {
      ...
      type: "Habilidad",
      position: [
        { pos: "topicText", size: "52", y: "85", x: "17" },
        { pos: "topicImg", size: "300", y: "56", x: "90" },
        { pos: "topicBlur", size: "32", y: "82", x: "18" },
      ],
      img: "assets/category/ability/ico-Trabajo-en-equipo",
      color: "#034694",
      description:
        "Colabora, conecta y construye en conjunto. Aprende a liderar desde lo colectivo con inteligencia emocional.",
      universities: [
        {
    ...
    },
    {
      ...
      color: "#034694",
      description:
        "Descubre cómo las máquinas pueden aprender, adaptarse y tomar decisiones. Desde modelos predictivos hasta ética de la IA, prepárate para liderar la revolución tecnológica.",
      universities: [
        {
          name: "IBM",
          type: "Empresa",
    ...
    },
    {
      ...
      color: "#034694",
      description:
        "Habla el lenguaje que construye el futuro. Aprende a desarrollar software, automatizar tareas y resolver problemas con código.",
      universities: [
        {
          name: "IBM",
          type: "Empresa",
    ...
    },
    {
      ...
      color: "#034694",
      description:
        "Entiende cómo funcionan las marcas en la era digital. Aprende a atraer, convertir y fidelizar audiencias con herramientas y estrategias actualizadas.",
      universities: [
        {
    ...
    },
    {
      ...
      color: "#034694",
      description:
        "Explora el cerebro humano desde la ciencia. Comprende cómo pensamos, sentimos y aprendemos, y aplica este conocimiento en salud, educación y tecnología.",
      universities: [
        {
    ...
    },
    {
      ...
      color: "#034694",
      description:
        "Conoce el comportamiento humano en profundidad. Aprende teorías, métodos y herramientas para comprender, acompañar y transformar realidades personales y sociales.",
      universities: [
        {
    ...
    },
    {
      ...
      color: "#034694",
      description:
        "Descubre el poder narrativo y técnico del gaming. Aprende diseño, desarrollo y lógica interactiva en una industria creativa y en constante evolución.",
      universities: [
        {
    ...
    },
    {
      ...
      description:
        "Diseña nuevas formas de enseñar y aprender. Explora metodologías, tecnologías y enfoques que hacen de la educación una experiencia transformadora.",
      universities: [
        {
          name: "Stanford University",
          type: "Universidad",
  ...
  const normalizeTopicType = (type) => {
    const value = String(type || "").trim().toLowerCase();

    if (value === "tema" || value === "habilidad") {
      return "Skill";
    }
  ...
  const topics = rawTopics.map(({ position, universities = [], ...topic }) => ({
    ...topic,
    type: normalizeTopicType(topic.type),
    universities: universities.map((item) => ({
      ...item,
      type: normalizeTopicType(item.type),
    })),
  }));
