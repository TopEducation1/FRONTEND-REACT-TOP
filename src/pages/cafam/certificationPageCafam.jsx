...
const CertificationPageCafam = () => {
  ...
  return (
    <div className="w-full bg-white platform-page">
      <div className="container  mx-auto py-25 md:py-50px lg:py-60px 2xl:py-100px ">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
          <div className="lg:col-start-1 lg:col-span-8 space-y-[35px] pb-8 border-1 border-[#ECECEC] rounded-[15px] z-1">
            <div className="container-main-info">
              ...
              <div className="nav-tab-wrapper px-8 py-5 w-full">
                <ul class="flex course-tab mb-8 w-auto">
                  <li>
                    <a className={`px-4 py-2 rounded ${activeTab === 'tab1' ? 'bg-blue-500 text-white' : 'bg-gray-300'}`} onClick={() => setActiveTab('tab1')}>Descripción</a>
                  </li>
                  <li>
                    <a className={`px-4 py-2 rounded ${activeTab === 'tab2' ? 'bg-blue-500 text-white' : 'bg-gray-300'}`} onClick={() => setActiveTab('tab2')}>Habilidades</a>
                  </li>
                  <li>
                    <a className={`px-4 py-2 rounded ${activeTab === 'tab3' ? 'bg-blue-500 text-white' : 'bg-gray-300'}`} onClick={() => setActiveTab('tab3')}>
                    {(certification.plataforma_certificacion && certification.plataforma_certificacion.nombre == 'MasterClass')?'Lecciones':'Modulos'}</a>
                  </li>
                </ul>
                  ...
                  {activeTab === 'tab3' && <div className="grid-main-info-section cert-habi w-full gap-5">
                    {(certification.contenido_certificacion && certification.plataforma_certificacion.nombre === 'MasterClass')?(
                        certification.contenido_certificacion.contenido_certificacion.reduce((modules, content, index) => {
                          ...
                          return (
                            <div key={index} className={`module-card mb-3 ${isExpanded ? 'expanded' : 'closed'}`} >
                              <div className="first-row">
                                <div className="wrapper-info">
                                  <h2>{modulo.titulo}</h2>
                                </div>
                                <div className="wrapper-row" onClick={() => setExpandedIndex(isExpanded ? null : index)} >
                        ...
                        certification.modulos_certificacion.map((modulo, index) => {
                          const isExpanded = expandedIndex === index;
                          return (
                            <div key={index} className={`course-accrodain space-y-3 mb-3 module-card ${isExpanded ? 'expanded' : 'closed'}`}>
                              <div className="first-row">
                                <div className="wrapper-info">
          ...
          <div className="lg:col-start-9 lg:col-span-4 br-15 border-1 border-[#ECECEC] rounded-[15px] z-1 sticky top-0" >
