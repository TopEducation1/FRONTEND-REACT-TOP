...
const CertificationPageCafam = () => {
    ...
    return (
        <>
            ...
            <div id="grid-main-content-cafam">
                ...
                <div className="container-main-info-cafam">
                    ...
                    <div id="container-button-url-original-cafam" className="grid-main-info-section">
                        <button onClick={() => window.open(certification.url_certificacion_original, '_blank')} className="button-url-original-cafam">Ver en la página oficial</button>
                    </div>
