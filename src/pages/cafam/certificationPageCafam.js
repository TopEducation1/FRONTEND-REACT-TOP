...
const CertificationPageCafam = () => {
  ...
  useEffect(() => {
    if (certification && certification.habilidades_certificacion) {
      const rows = Math.ceil(
        certification.habilidades_certificacion.length / 4
      );
      setSkillsCount(rows);
    }
  }, [certification]);
  ...
  return (
    <div
      id="grid-main-content-cafam"
      className={`grid-layout-${positionPopUp ? "mobile" : "desktop"}`}
    >
      ...
      <div className="container-main-info-cafam">
        ...
        {/* Short Description */}
        <div
          id="container-short-description"
          className="grid-main-info-section"
        >
        ...
        {/* Original URL Button */}
        <div
          id="container-button-url-original-cafam"
          className="grid-main-info-section"
        >
          <button
            onClick={() =>
        ...
        <div id="container-instructors" className="grid-main-info-section">
          ...
          <ul>
            {certification.instructores_certificacion.map(
              (instructor, index) => (
        ...
        <div id="container-fast-info" className="grid-main-info-section">
          {certification.lenguaje_certificacion &&
            !certification.lenguaje_certificacion.startsWith("x") && (
              <div className="fast-info-cafam">
                <h3>Idioma</h3>
                {certification.lenguaje_certificacion}
              </div>
            )}
          {certification.nivel_certificacion &&
            !certification.nivel_certificacion.startsWith("x") && (
              <div className="fast-info-cafam">
                <h3>Nivel</h3>
                {certification.nivel_certificacion}
              </div>
          ...
          {certification.tiempo_certificacion &&
            !certification.tiempo_certificacion.startsWith("x") && (
              <div className="fast-info-cafam">
                <h3>Cronograma</h3>
                {certification.tiempo_certificacion}
              </div>
        ...
        {certification.aprendizaje_certificacion &&
          !certification.aprendizaje_certificacion.some((aprendizaje) =>
            ...
            <div id="container-learning" className="grid-main-info-section">
              ...
              <ul>
                {certification.aprendizaje_certificacion?.map(
                  (aprendizaje, index) =>
        ...
        {/* Skills Section */}
        {!certification.habilidades_certificacion.some((habilidad) =>
          habilidad.nombre.startsWith("x")
        ) && (
          <div id="container-skills" className="grid-main-info-section">
            ...
            >
              {certification.habilidades_certificacion.map(
                (habilidad, index) => (
                ...
                {isExpanded && (
                  <div className="second-row">
                    <div className="content-module-container">
                      <div className="content-module">{modulo.contenido}</div>
                    </div>
                  </div>
                )}
              </div>
      ...
      <div id="container-areas-cafam">
        <div id="wrapper-title-areas-cafam">
          <h1>Explora áreas del conocimiento</h1>
        </div>
        <div id="wrapper-show-areas-cafam">
          <div className="area-circle-object">
            <img
              src="/assets/Areas-Conocimiento/area-conocimiento-1.png"
              alt="Área de Conocimiento 1"
            />
          </div>
          <div className="area-circle-object">
            <img
              src="/assets/Areas-Conocimiento/area-conocimiento-2.png"
              alt="Área de Conocimiento 2"
            />
          </div>
          <div className="area-circle-object">
            <img
              src="/assets/Areas-Conocimiento/area-conocimiento-3.png"
              alt="Área de Conocimiento 3"
            />
          </div>
        </div>
      </div>
      ...
      <div id="container-classes-cafam">
        <div id="wrapper-title-classes-cafam">
          <h1>Clases recomendadas para ti</h1>
        </div>
        <div id="wrapper-slider-masterclass-cafam">
          <div className="card-masterclass">
            <img
              src="/assets/MasterClass/masterclass-1.png"
              alt="masterclass-imagen"
            />
          </div>
          <div className="card-masterclass">
            <img
              src="/assets/MasterClass/masterclass-2.png"
              alt="masterclass-imagen"
            />
          </div>
          <div className="card-masterclass">
            <img
              src="/assets/MasterClass/masterclass-3.png"
              alt="masterclass-imagen"
            />
          </div>
        </div>
      ...
      <div id="container-promotion-cafam">
        <div id="promotion-grid-cafam">
          <div className="div-grid-promotion" id="upper-left-div">
            <img
              src="/assets/banners/promotion-banner.jpg"
          ...
          <div className="div-grid-promotion" id="upper-right-div">
            ...
            <p>
              Imagina tener acceso ilimitado al catalogo de edX, Masterclass, y
              Coursera, todo en una sola plataforma y por menos de la mitad del
              precio que pagarias por las tres plataformas.
            </p>
          </div>
      ...
      {positionPopUp ? (
        <div
          id="container-certifications-interest-mobile"
          className="certifications-sidebar-mobile"
        >
